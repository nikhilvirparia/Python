...
//                 result.push(arr1[i]) // push in array 1
//
//             }
//
//         } else {
//
//             // Looping through the array 2
//             for (let j = 0; j < arr2.length; j++) {
//                 result.push(arr2[j]) // push in array 2
//             }
//
//         }
//
...
// //https://www.hackerearth.com/practice/algorithms/sorting/merge-sort/visualize/  with
// // this array [2,4,6,3,5,1,9,0] start at step 74 for the logic if you need a hint
//
// console.log(combine([2,3,4,6], [0,1,5,9]))
//
//
// const merge = (arr)=>{
//     //this function will break down one unsorted array
//     // into single element arrays and recursively call
//     // the combine function to combine the already sorted arrays- hint--> you can use .slice()
// }
